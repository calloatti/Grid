...
{
  public class WaterRiseTool : ITool, IInputProcessor, IToolDescriptor
  {
    ...
    {
      _cursor = _assetLoader.Load<Texture2D>("Resources/ui/cursors/water-cursor-rise");
    }
