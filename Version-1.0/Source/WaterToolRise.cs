...
{
  public class WaterToolRise : ITool, IInputProcessor, IToolDescriptor
  {
    ...
    private void LoadCursors() => _cursor = _assetLoader.Load<Texture2D>("Resources/ui/cursors/water-cursor-rise");
    ...
    public bool ProcessInput()
    {
      ...
      if (_inputService.MainMouseButtonDown)
      {
        ...
        {
          var newBlocks = connected.Select(v => new Vector3Int(v.x, v.y, v.z + 1)).ToList();
    ...
    {
      return new ToolDescription.Builder(_loc.T("Calloatti.Grid.WaterRiseToolTitle"))
          .AddSection(_loc.T("Calloatti.Grid.WaterRiseToolDescription"))
          .Build();
    }
  }
}