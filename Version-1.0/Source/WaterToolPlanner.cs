...
{
  public class WaterToolPlanner : ITool, IToolDescriptor, ILoadableSingleton
  {
    ...
    private readonly Color _previewColor = new Color(0.5f, 0.7f, 1.0f, 0.9f);

    public WaterToolPlanner(
    ...
    private void OnShowNone() => _areaHighlightingService.UnhighlightAll();
