...
{
  public class WaterToolDeleteAll : ITool, IInputProcessor, IToolDescriptor
  {
    ...
    public WaterToolDeleteAll(ToolService toolService, InputService inputService, ILoc loc, WaterPlannedArea waterPlannedArea)
    {
