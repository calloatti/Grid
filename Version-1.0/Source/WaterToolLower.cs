...
{
  public class WaterToolLower : ITool, IInputProcessor, IToolDescriptor
  {
    ...
    private void LoadCursors() => _cursor = _assetLoader.Load<Texture2D>("Resources/ui/cursors/water-cursor-lower");
