...
{
  public class RulerToolDeleteAll : ITool, IInputProcessor, IToolDescriptor
  {
    ...
    public RulerToolDeleteAll(ToolService toolService, InputService inputService, ILoc loc, RulerService rulerService)
    {
